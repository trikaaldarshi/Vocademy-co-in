...
export const Welcome: React.FC<WelcomeProps> = ({ navigateTo }) => {
    ...
    if (firebaseFunctions.initializeApp && firebaseFunctions.getAuth && firebaseFunctions.applyActionCode) {
      ...
      if (app) {
        ...
        if (oobCode) {
          ...
          // If no code, we still show success to allow entry to the app
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-6 relative overflow-hidden">
      {/* Background Animated Blobs - Original Style */}
        ...
        {status === 'loading' && (
          <div className="space-y-8 py-10">
            ...
            <div className="space-y-3">
              ...
              <p className="text-gray-500 dark:text-gray-400 font-medium">Securing your access through our platform...</p>
            </div>
          </div>
        )}
          ...
          <div className="space-y-10 py-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 font-medium text-lg leading-relaxed">
                Your account is verified. You're now set to transform your preparation with Vocademy's AI tools.
              </p>
            </div>
          ...
          <div className="space-y-10 py-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 font-medium">
                Please try requesting a new link or contact support if the issue persists.
              </p>
            </div>
            <div className="pt-6">
              <button 
